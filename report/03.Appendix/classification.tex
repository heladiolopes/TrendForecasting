...
Cross-validation results for support vector classifier from sklearn, hyperparamter: $C = 1$ and $\text{kernel}=\text{linear}$, with bag of words.
...
Cross-validation results for support vector classifier from sklearn, hyperparamter: $C = 1$ and $\text{kernel}=\text{linear}$, with TF-IDF.
