...
\begin{figure}[h!]
	...
	\caption{Flowchart of the proposed framework. Figure from  \citeonline{hurtado2016topic}.}
...
\begin{figure}[h!]
	...
	\caption{Ensemble forecaster framework. Figure from  \citeonline{hurtado2016topic}.}
